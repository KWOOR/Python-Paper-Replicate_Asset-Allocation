...
print('EQ Return의 Sharpe:', (eqpf['eqret'].mean()*12-0.02)/(eqpf['eqret'].std()*(12**(1/2))))
print('EQ Return의 MDD:', MDD(eqpf['price']))
#%%
...
print('VW Return의 Sharpe:', (vwpf['vwret'].mean()*12-0.02)/(vwpf['vwret'].std()*(12**(1/2))))
print('VW Return의 MDD:', MDD(vwpf['price']))
...
print('MoM Return의 Sharpe:', (mompf['ret'].mean()*12-0.02)/(mompf['ret'].std()*(12**(1/2))))
print('MoM Return의 MDD:', MDD(mompf['price']))
...
print('MomVW Return의 Sharpe:', (momvwpf['ret'].mean()*12-0.02)/(momvwpf['ret'].std()*(12**(1/2))))
print('MoMVW Return의 MDD:', MDD(momvwpf['price']))
...
print('Minvar Return의 Sharpe:', (minvar['ret'].mean()*12-0.02)/(minvar['ret'].std()*(12**(1/2))))
print('EQ Return의 MDD:', MDD(minvar['price']))
